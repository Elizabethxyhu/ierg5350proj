...
pred_length=np.load('C:\\Users\\ChengYuansen\\Desktop\\2020-2021_1\\IERG5230\\TSP_DRL_PtrNet-master-course\\loss_file\\list_pred_ave_len_node5.npy')
...
'''
#显示图例
p3 = pl.plot(x,pred_length, 'b-', label = u'RL+Pointer_Network')
pl.legend()
...
pl.xlabel(u'epoch')
pl.ylabel(u'length')
plt.title('Tour length - P+O TSP5')
...
plt.savefig("train_results_length_TSP5.png")
pl.show()
